...
const Mat4 ROTATION_PITCH_INVERSE (Vec4(1, 0, 0, 0), Vec4(0, std::cos(-THETA), -std::sin(-THETA), 0), Vec4(0, std::sin(-THETA), std::cos(-THETA), 0), Vec4(0, 0, 0, 1));
const Mat4 ROTATION_YAW_INVERSE   (Vec4(std::cos(-THETA), 0, std::sin(-THETA), 0), Vec4(0, 1, 0, 0), Vec4(-std::sin(-THETA), 0, std::cos(-THETA), 0), Vec4(0, 0, 0, 1));
const Mat4 ROTATION_ROLL_INVERSE  (Vec4(std::cos(-THETA), std::sin(-THETA), 0, 0), Vec4(-std::sin(-THETA), std::cos(-THETA), 0, 0), Vec4(0, 0, 1, 0), Vec4(0, 0, 0, 1));
